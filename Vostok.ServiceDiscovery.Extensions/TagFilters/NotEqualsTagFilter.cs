...
{
    /// <summary>
    /// An implementation of <see cref="ITagFilter" /> that implements "not equals" expression.
    /// </summary>
    [PublicAPI]
    public class NotEqualsTagFilter : ITagFilter
    {
        public NotEqualsTagFilter([NotNull] string key, [NotNull] string value)
        {
